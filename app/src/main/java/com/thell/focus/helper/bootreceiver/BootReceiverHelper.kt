package com.thell.focus.helper.bootreceiver
...
class BootReceiverHelper private constructor() {
    ...
    private fun startIntent(
        ...
        try {
            ...
            activity.startActivityForResult(intent, PermissionHelper.BOOT_PERMISSION_REQUEST_CODE)
    ...
    companion object
    {
        private lateinit var mInstance: BootReceiverHelper

        fun getInstance() : BootReceiverHelper
        {
            if(!Companion::mInstance.isInitialized)
                mInstance= BootReceiverHelper()
